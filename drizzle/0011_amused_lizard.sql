...
CREATE INDEX IF NOT EXISTS "merchants_active_number_idx" ON "merchants" USING btree ("merchant_number","id") WHERE "merchants"."deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "merchants_active_created_idx" ON "merchants" USING btree ("created_at","id") WHERE "merchants"."deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "merchants_active_business_name_lower_idx" ON "merchants" USING btree (lower("business_name"),"id") WHERE "merchants"."deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "merchants_active_stage_created_idx" ON "merchants" USING btree ("onboarding_stage","created_at","id") WHERE "merchants"."deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "merchants_active_priority_created_idx" ON "merchants" USING btree ("priority","created_at","id") WHERE "merchants"."deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "merchants_active_status_id_idx" ON "merchants" USING btree ("status","id") WHERE "merchants"."deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "merchants_active_scope_id_idx" ON "merchants" USING btree ("business_scope","id") WHERE "merchants"."deleted_at" IS NULL;--> statement-breakpoint
